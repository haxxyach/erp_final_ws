...
(cl:defmethod cl:initialize-instance :after ((m <erpStatusMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'erpStatusMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name erp-msg:<erpStatusMsg> is deprecated: use erp-msg:erpStatusMsg instead.")))

(cl:ensure-generic-function 'control_mode-val :lambda-list '(m))
(cl:defmethod control_mode-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:control_mode-val is deprecated.  Use erp-msg:control_mode instead.")
  (control_mode m))

(cl:ensure-generic-function 'e_stop-val :lambda-list '(m))
(cl:defmethod e_stop-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:e_stop-val is deprecated.  Use erp-msg:e_stop instead.")
  (e_stop m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:gear-val is deprecated.  Use erp-msg:gear instead.")
  (gear m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:speed-val is deprecated.  Use erp-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:steer-val is deprecated.  Use erp-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:brake-val is deprecated.  Use erp-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'encoder-val :lambda-list '(m))
(cl:defmethod encoder-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:encoder-val is deprecated.  Use erp-msg:encoder instead.")
  (encoder m))

(cl:ensure-generic-function 'alive-val :lambda-list '(m))
(cl:defmethod alive-val ((m <erpStatusMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader erp-msg:alive-val is deprecated.  Use erp-msg:alive instead.")
  (alive m))
